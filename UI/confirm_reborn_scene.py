...
class ConfirmScene(BaseScene):
    def __init__(self, screen):
        ...
        self.button_yes = ImageButton("resource/image/yes_no_button.png", (400, 400), text="是", font=font)
        self.button_no = ImageButton("resource/image/yes_no_button.png", (700, 400), text="否", font=font)
